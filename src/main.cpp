...
#define BUNNY 1
#define PLANE 2
#define CHARACTER_BODY 3
#define CHARACTER_HEAD 4
...
int main(int argc, char *argv[])
{
    ...
    // CARREGANDO TEXTURAS DO PERSONAGEM
    LoadTextureImage("../../data/BODY.png");         // TextureImage2
    LoadTextureImage("../../data/CLOTHES_MALE.png"); // TextureImage3
    LoadTextureImage("../../data/HEAD.png");         // TextureImage4
    ...
    // ADICIONANDO OBJETO DO PERSONAGEM
    ObjModel charmodel("../../data/PEAKchar.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 cam = Matrix_Camera_View(camera_position_c, camera_view_vector, camera_up_vector);
...
void LoadShadersFromFiles()
{
    ...
    // ADICIONANDO TEXTURAS DO PERSOANGEM
