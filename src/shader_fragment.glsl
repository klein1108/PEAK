...
void main()
{
    ...
    }  else if ( object_id == CHARACTER_BODY ) {
        // Coordenadas de textura do personagem, obtidas do arquivo OBJ.
        U = texcoords.x;
        V = texcoords.y;
    ...
    } else if ( object_id == CHARACTER_HEAD ) {
        U = texcoords.x;
        V = texcoords.y;
        Kd0 = texture(TextureImage4, vec2(U,V)).rgb;

    } else if ( object_id == CHARACTER_CLOTHES ) {
        U = texcoords.x;
        V = texcoords.y;
